...
const member = message.bot.fetchUser(args[0]) || message.guild.member(message.mentions.users.first() || message.guild.members.get(args[0]) || message.member || message.author);

...
const member = message.bot.users(message.mentions.members.first() || bot.fetchUser(args[0]) || message.guild.member(message.mentions.users.first() || message.guild.members.get(args[0]) || message.member || message.author));

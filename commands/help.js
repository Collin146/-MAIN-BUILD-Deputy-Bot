...
.addField("!strike <1 or 2> <user> <reason>", "This adds the Strike 1 or 2 role (depending on what number you provided) role to the mentioned user and sends them a DM telling them that they have been striked.")
.addField("!watchlist <user> <reason>", "This adds the Watchlist role to the mentioned user and sends them a DM telling them that they have been put on watchlist.")
...
.addField("!unmute <user>", "This command unmutes a user who has been muted by the !tempmute command.")
.addField("!dm <message>", "This sends a DM to all of the users that are in the guild that this command is used in with the message that is provided.")
.addBlankField(true)

...
//let tostrike = message.guild.member(message.mentions.users.first() || message.guild.members.get(args[1]));
const tostrike = message.mentions.users.first() || await message.GuildMember.fetch(args[1])

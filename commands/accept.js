...
let acceptembed = new Discord.RichEmbed()
      ...
      .setDescription([
          ...
          `**Status:** Approved`,
          `**Message:** Your application has been approved! You have taken your first step into the community. The next step is to wait for an interview to be announced/scheduled in <#644273618011815946>. We wish you good luck! Please keep in mind that you will have a total of 30 days to attend an interview. If you fail to do so within those 30 days, your approved for interview status will unfortunately be removed and you will be forced to reapply if you want to be eligible for interviews again. To see how many days you have left, please refer to the following document: https://bit.ly/3kxyyr5 (note: it may take several hours before you get added to the document).`,
        ].join('\n'))

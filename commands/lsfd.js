...
let probrole = message.guild.roles.find(x => x.name === 'Probationary Firefighter');
...
let errEmbed4 = new Discord.RichEmbed()
      .setColor("RED")
      .setTitle(`${no} **Error!**`)
      .setDescription("The role \"LSFD\" doesn't exist.");
...
.setColor("BLACK")
.setDescription([
    `**The moderation command** !lsfd **has been used**`,
    ` `,
    `**Used On:** <@${tobcso.id}>`,
    ` `,

...
let memberrole = member.guild.roles.cache.get(x => x.name === 'New Member');

member.roles.add(memberrole);

try {

let applicantrole = member.guild.roles.cache.get(x => x.name === 'Applicant');
...
let recruitrole = member.guild.roles.cache.get(x => x.name === 'Recruit');
...
let memberrole22 = member.guild.roles.cache.get(x => x.name === 'Member');
...
//             if (message.author.id === message.guild.ownerID) return;
//             if (message.member.hasPermission("ADMINISTRATOR")) return;
//             if (message.guild.roles.cache.get(x => x.name === 'Staff Team')) return;
//             await message.delete();
...
//    // try {
//         //if (bannedWords.some(word => message.content.toLowerCase().includes(word))) {
//            // let commrole = message.guild.roles.cache.get('name', 'Community Manager'); 
...
//    let staffrole = message.guild.roles.cache.get(x => x.name === 'Staff Team');
...
let muterole = member.guild.roles.cache.get(x => x.name === 'Muted');
let memberrole = member.guild.roles.cache.get(x => x.name === 'Member');
let approle = member.guild.roles.cache.get(x => x.name === 'Applicant');
let recrole = member.guild.roles.cache.get(x => x.name === 'Recruit');
    ...
    bot.on('messageReactionAdd', async (messageReaction, user) => {
        ...
        if (messageReaction.message.id === "770020659929153566") {
            ...
            if (messageReaction.emoji.id === drp1.id) {
                ...
                let mentionrole = messageReaction.message.guild.roles.cache.get(x => x.name === 'Member');
            ...
            if (messageReaction.emoji.id === no.id) {
                ...
                if (user.id === '385777873581113344' || user.id === '292598566759956480' || user.id === '724991641932267612') {
                    ...
                    let permRole = messageReaction.message.guild.roles.cache.get(x => x.name === 'Member');
...
bot.on("ready", async () => {
    ...
    if (messageReaction.message.id === "759132165354160178") {
        ...
        let roledrpmember = messageReaction.message.guild.roles.cache.get(x => x.name === 'DRP Member');
        let roledrprecruit = messageReaction.message.guild.roles.cache.get(x => x.name === 'DRP Recruit');
        let roledrpapplicant = messageReaction.message.guild.roles.cache.get(x => x.name === 'DRP Applicant');
        let roleps4 = messageReaction.message.guild.roles.cache.get(x => x.name === 'Playstation');
        let rolexbox = messageReaction.message.guild.roles.cache.get(x => x.name === 'Xbox');
        let rolepc = messageReaction.message.guild.roles.cache.get(x => x.name === 'PC');
        let roleninswitch = messageReaction.message.guild.roles.cache.get(x => x.name === 'Nintendo Switch');
...
//   let memberrole = newMember.guild.roles.cache.get(x => x.name === 'Deputy Director');
...
// let memberrole = oldMember.guild.roles.cache.get(x => x.name === 'Owner');
...
try {
    ...
    let patrolrole = mainguild.roles.cache.get(x => x.name === 'On Patrol');

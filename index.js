    ...
    if (messageReaction.message.channel.type === 'dm') {
        ...
        const drp7 = bot.emojis.get("759126083781394444");
                    ...
                    if (messageReaction.emoji.id === drp1.id) {
                        ...
                        let mainguild1 = bot.guilds.get('644254160019128320')
    ...
    bot.on('messageReactionAdd', async (messageReaction, user) => {
        ...
        if (messageReaction.message.id === "770020659929153566") {
            ...
            if (messageReaction.emoji.id === drp1.id) {
                ...
                if (users.has('385777873581113344') || users.has('292598566759956480') || users.has('724991641932267612') || users.has('435071631426060288') || users.has('409421412248584194') || users.has('493695805870309378') || users.has('470632586360651777') || users.has('464537564494168083') || users.has('279057499791949824')) {
...
try {
    ...
    let srutac1 = mainguild.channels.find(x => x.name === 'Tac 1');
    let srutac2 = mainguild.channels.find(x => x.name === 'Tac 2');
    ...
    if(newUserChannel.id === srutac1.id) newMember.addRole(patrolrole.id);
    if(newUserChannel.id === srutac2.id) newMember.addRole(patrolrole.id);
    ...
    if(oldUserChannel.id === srutac1.id) newMember.removeRole(patrolrole.id);
    if(oldUserChannel.id === srutac2.id) newMember.removeRole(patrolrole.id); 
    ...
    if(newUserChannel.id === srutac1.id) return;
    if(newUserChannel.id === srutac2.id) return;
